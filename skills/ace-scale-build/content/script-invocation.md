...
AI guidance for calling Ace Scale Build scripts. Run from `agile-context-engine` root.
...
**Usage:**
```bash
python skills/ace-scale-build/scripts/scaffold.py --name ace-<name> [--path skills/ace-<name>]
```
...
**Usage (from ace-scale-build itself):**
```bash
